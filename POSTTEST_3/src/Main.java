...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        dataKucing.add(new KucingDomestik(idCounter++, "Oren", "Domestik", 1, "Tersedia", true));
        dataKucing.add(new KucingLangka(idCounter++, "Mochi", "Persia", 2, "Tersedia", "CFA Certified"));
        dataKucing.add(new KucingFeral(idCounter++, "Garuk", "Kampung", 3, "Diadopsi", false));
    ...
    static void create() {
        ...
        switch (jenis) {
            case 1:
                ...
                System.out.println("Data Kucing Domestik berhasil ditambah.");
                break;
            case 2:
                scanner.nextLine();
                ...
                System.out.println("Data Kucing Langka berhasil ditambah.");
                break;
            case 3:
                ...
                System.out.println("Data Kucing Feral berhasil ditambah.");
                break;
            default:
                System.out.println("Jenis tidak valid.");
                return;
        }
        if (kucingBaru != null) dataKucing.add(kucingBaru);
    }
    ...
    static void update() {
        ...
        if (target != null) {
            ...
            System.out.print("Status baru: "); target.setStatus(scanner.next());
    ...
    static void delete() {
        ...
        System.out.println(dihapus ? "Data dihapus!" : "ID ga ditemukan!");
    }
